...
/*   Updated: 2024/04/07 00:20:53 by madamou          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_printf(const char *str, ...)
{
	...
	while (str[++i])
	{
		...
		if (str[i] == '%' && str[i + 1] == '%')
			...
			print = ft_hexa_lowercase(print, (unsigned int)va_arg(args, unsigned int));
		else if (str[i] == '%' && str[i + 1] == 'X')
			print = ft_hexa_uppercase(print, (unsigned int)va_arg(args, unsigned int));
...
// int	main(void)
// {
// 	ft_printf("je test %c un truc %2d %s %%\n", 'c', 42, "j'aime la vie");
// 	printf("je test %c un truc %2d %s %%\n", 'c', 42, "j'aime la vie");
// }